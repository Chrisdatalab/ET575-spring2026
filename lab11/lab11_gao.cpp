...
int main(){
    ...
    //while loop print from 1 to 5,step of 1 ----> 1,2,3,4,5
    ...
    //print from 3 to 0 step of 3 --> 3,2,1,0
    int m =3;
    while(m>=0){
        cout<<m<<"\t";
        m--;
    ...
    //while loop to validate if a number is not betwwen 10 and 20
    int n;
    cout <<"Enter a number: ";
    cin>>n;
    ...
    cout<<"\n-----------example 8: do while loop to validate an input----------"<<endl;
    ...
    // if the amount is greater than the balance or negative, the program will recollect another anount
    int balance=1000;
    int w=0;
    while(true){
